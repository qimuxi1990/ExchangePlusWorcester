...
for($t = 0; $t < sizeof($triesArr); $t++){ 
    ...
    for($s = 0; $s < 2; $s++){ // test 10 times, and compute the average time_taken
        ...
        // $recover_query_user = array('_id'=>200);
        // $recover_cursor_user = $collection_users->findOne($recover_query_user);
        // echo "user after recover: "."<br>";
        // var_dump($recover_cursor_user);
    }// end for($s = 0; $s < 10; $s++)
