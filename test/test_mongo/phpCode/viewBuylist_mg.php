<?php
// test case: user want to view his/her buylist including detail product infomation
// input: a random list of {"pid":...; "offering_price":...; "status":...} (size = 10)
// output: user's buylist, including productname, category, demanding_price, image, seller_id
